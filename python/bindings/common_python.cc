...
void bind_common(py::module& m)
{
    ...
    py::enum_<::gr::gsm::filter_policy>(m,"filter_policy")
        .value("FILTER_POLICY_DEFAULT", ::gr::gsm::FILTER_POLICY_DEFAULT) // 0
        .value("FILTER_POLICY_PASS_ALL", ::gr::gsm::FILTER_POLICY_PASS_ALL) // 1
        .value("FILTER_POLICY_DROP_ALL", ::gr::gsm::FILTER_POLICY_DROP_ALL) // 2
        .export_values()
    ;
