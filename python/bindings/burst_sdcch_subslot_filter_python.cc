...
/* BINDTOOL_HEADER_FILE_HASH(bf02565acccf7e8b8b9cead5bac1832b)                     */
/***********************************************************************************/
...
void bind_burst_sdcch_subslot_filter(py::module& m)
{
    ...
    py::enum_<::gr::gsm::subslot_filter_mode>(m,"subslot_filter_mode")
        .value("SS_FILTER_SDCCH8", ::gr::gsm::SS_FILTER_SDCCH8) // 0
        .value("SS_FILTER_SDCCH4", ::gr::gsm::SS_FILTER_SDCCH4) // 1
        .export_values()
    ;
