...
void bind_tch_f_decoder(py::module& m)
{
    ...
    py::enum_<::gr::gsm::tch_mode>(m,"tch_mode")
        .value("TCH_AFS12_2", ::gr::gsm::TCH_AFS12_2) // 0
        .value("TCH_AFS10_2", ::gr::gsm::TCH_AFS10_2) // 1
        .value("TCH_AFS7_95", ::gr::gsm::TCH_AFS7_95) // 2
        .value("TCH_AFS7_4", ::gr::gsm::TCH_AFS7_4) // 3
        .value("TCH_AFS6_7", ::gr::gsm::TCH_AFS6_7) // 4
        .value("TCH_AFS5_9", ::gr::gsm::TCH_AFS5_9) // 5
        .value("TCH_AFS5_15", ::gr::gsm::TCH_AFS5_15) // 6
        .value("TCH_AFS4_75", ::gr::gsm::TCH_AFS4_75) // 7
        .value("TCH_FS", ::gr::gsm::TCH_FS) // 8
        .value("TCH_EFR", ::gr::gsm::TCH_EFR) // 9
        .value("TCH_HS", ::gr::gsm::TCH_HS) // 10
        .export_values()
    ;
